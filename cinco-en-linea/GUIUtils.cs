...
namespace cinco_en_linea
{
	...
	{
		Rectangle R;
		public Rectangle Origen { get { return R; } }
		public Point Destino { get; private set; }
		public Int32 Pasos { get; private set; }
		public Boolean Ready { get { return Pasos == 0; } }
		public Mover (Rectangle _Origen, Point _Destino, Int32 _Pasos)
		{
			R = _Origen;
			Destino = _Destino;
			Pasos = _Pasos;
		...
		public Rectangle Next ()
		{
			Int32 X = (Destino.X - Origen.X) / Pasos;
			Int32 Y = (Destino.Y - Origen.Y) / Pasos;
			R.Offset(X, Y);
			Pasos--;
			return R;
		}
		public void ChangeDestination(Point Dest)
		{
			Destino = Dest;
		}
		public void ChangeRectangle (Rectangle _R)
		{
			R = _R;
		}
	}
